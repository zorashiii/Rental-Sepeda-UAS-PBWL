    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('rental_update', ['id' => $row->id]) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="tgl_rent" class="form-control" value="{{ $row->tgl_rent }}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="hari" id="hari" class="form-control"value="{{ $row->hari }}">
                        </div>

                        <div class="mb-3">
                            <label for="inputTotal" class="form-label">Total Harga</label>
                            <input type="text" name="total_harga" id="total_harga" value="{{ $row->total_harga }}">
                        </div>
